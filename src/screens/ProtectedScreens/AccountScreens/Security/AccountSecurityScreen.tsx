...
const AccountSecurityScreen = () => {
  ...
  return (
    <View className='flex-1 bg-white px-4'>
      ...
      <TouchableOpacity onPress={()=> navigation.navigate("verify-password", { type: "verify", HeaderTitle: "Verify Password", message: "For your security, please enter your old password.", btnText: "Verify Password", placeHolderText: "Enter your password" })} style={{paddingVertical: Responsiveness.getResponsiveHeight(2), borderBottomWidth: 1, borderColor: 'lightgray'}} className='flex flex-row justify-between'>
